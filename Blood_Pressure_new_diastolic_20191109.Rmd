...
### VIF computed to determine if there is any multi-collinearity in diastolic model
```{r}
library(car)
```
```{r}
...
#residuals vs fitted values plot
plot(fitted(m_d4_trans_out_comb), rstandard(m_d4_trans_out_comb))
abline(a=0,b=0,col='red')
plot(bp_d_less_out$LabTriglycerides2,  rstandard(m_d4_trans_out_comb), main="Triglycerides vs residuals plot for M2")
abline(a=0, b=0,col='red')
plot(bp_d_less_out$BMI,  rstandard(m_d4_trans_out_comb), main="BMI vs residuals plot for M2")
abline(a=0, b=0,col='red')
plot(bp_d_less_out$Alcohol2,  rstandard(m_d4_trans_out_comb), main="Alcohol vs residuals plot for M2")
abline(a=0, b=0,col='red')
#normal probability plot of residuals
qqnorm(rstandard(full_sys_transformed))
qqline(rstandard(full_sys_transformed),col=2)
